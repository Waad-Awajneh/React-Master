    ...
    line-height: 4px; */}
                  <div className="w-full p-4 lg:order-1 ">
                    <div className="flex items-center gap-8  justify-between align-middle  font-[Satisfy]  ">
                        ...
                        <SiStackexchange size={"25px"}  color={"#D9AD90"} />  {userProfileData.posts?.length}
                        </span>
                      ...
                      <HiUserGroup size={"25px"}  color={"#D9AD90"} />  {userProfileData.follower_info.length}
                      {console.log(userProfileData)}
                        </span> 
                        </div>
     ...
     <AiOutlineComment size={"25px"} color={"#D9AD90"}  />        {userProfileData.comments == null
                            ? 0
                            : userProfileData.comments.length}
                        </span>
